...
public class Dialogo : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            "Os holofotes foram acesos e revelaram a sua misteriosa figura. Eu não conhecia a suas origens, mas agora, sei. Independente disso tudo, ele sempre foi bom comigo, era como um pai para mim." 
            + Environment.NewLine + "Éramos sós, não tínhamos mais ninguém, e tivemos de aprender a lidar com a solidão de duas pessoas. Tendo aquela vida mediana e pacata, eu jamais imaginaria o que estava por vir."
            + Environment.NewLine + " "
            ...
            + Environment.NewLine + " "
            + Environment.NewLine + "Havia ali nele, uma essência que o fazia seguir sob qualquer circunstância, além de suas virtudes e o seu conhecimento memorável. Acredito que esta é a razão pela qual o escolheram, o arrancaram de mim, deixando-me aqui aprisionado, sem respostas."
